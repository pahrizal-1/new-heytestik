class ClinicModel {
  ...
  ClinicModel({this.success, this.message, this.data});
...
class MediaClinics {
  ...
  MediaClinics.fromJson(Map<String, dynamic> json) {
    ...
    updatedAt = json['updated_at'];
    deletedAt = json['deleted_at'];
    media = json['media'] != null ? Media2.fromJson(json['media']) : null;
  }
...
class Treatments {
  ...
  Treatments.fromJson(Map<String, dynamic> json) {
    ...
    price =
        int.parse(double.parse(json['price'].toString()).round().toString());
    isActive = json['is_active'];
    rating = json['rating'];
    createdBy = json['created_by'];
    updatedBy = json['updated_by'];
