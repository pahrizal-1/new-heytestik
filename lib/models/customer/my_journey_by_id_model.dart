class MyJourneyByIdModel {
  bool? success;
  String? message;
  Data? data;

  MyJourneyByIdModel({this.success, this.message, this.data});

  MyJourneyByIdModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (journey != null) {
      data['journey'] = journey!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
