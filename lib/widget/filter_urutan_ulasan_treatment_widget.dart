...
class FilterUrutanUlasanTreatmentWidget extends StatefulWidget {
  String? val;
  FilterUrutanUlasanTreatmentWidget({super.key, this.val});

  @override
  State<FilterUrutanUlasanTreatmentWidget> createState() =>
      _FilterUrutanUlasanTreatmentWidgetState();
}

class _FilterUrutanUlasanTreatmentWidgetState
    extends State<FilterUrutanUlasanTreatmentWidget> {
  List data = [
