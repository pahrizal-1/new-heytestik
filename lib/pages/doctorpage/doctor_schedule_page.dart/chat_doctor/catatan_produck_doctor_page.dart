              ...
              child: InkWell(
                onTap: () {
                  ...
                  if (!isValid) {
                    ...
                    // print("error");
                    state.postDoctorNote(
                      context,
                      widget.idConstul!.toInt(),
                      isSelected,
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Apakah Profile yang dipilih sudah benar',
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        validator: (text) {
                          if (text == null || text.isEmpty) {
                            return 'Tolong Lengkapi Data Terlebih Dahulu';
                          }
                          return null;
                        },
                      ...
                      Row(
                        children: [
                          Radio(
                            value: 'Laki-laki',
                            groupValue: state.selectedGender.value,
                            onChanged: (value) {
                              setState(() {
                                state.selectedGender.value = value.toString();
                              });
                            },
                          ),
                          Text('Laki-laki'),
                ...
                TextFormField(
                  validator: (text) {
                    if (text == null || text.isEmpty) {
                      return 'Tolong Lengkapi Data Telebih Dahulu';
                    }
                    return null;
                  },
                  ...
                  builder: (_, state, __) {
                    return Container(
                      ...
                      child: ListView.builder(
                        ...
                        itemCount: state.hasMore.value ? state.listOfTreatment.length + 1 : state.listOfTreatment.length,
                        itemBuilder: (BuildContext context, int index) {
