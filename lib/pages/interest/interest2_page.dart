...
class Interest2Page extends StatefulWidget {
  const Interest2Page({super.key});

  @override
  State<Interest2Page> createState() => _Interest2PageState();
}

class _Interest2PageState extends State<Interest2Page> {
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text(
                    "Apakah anda mempunyai masalah kulit yang saat ini sedang anda hadapi?",
                    style: TextStyle(
                      fontFamily: 'ProximaNova',
                  ...
                  child: ButtonGreenWidget(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Interest3Page(),
                        ),
                      );
                    },
                  ),
