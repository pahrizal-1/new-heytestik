...
import 'package:heystetik_mobileapps/pages/interest/interest7_page.dart';
import 'package:heystetik_mobileapps/widget/button_widget.dart';

class Interest6Page extends StatefulWidget {
  const Interest6Page({super.key});

  @override
  State<Interest6Page> createState() => _Interest6PageState();
}

class _Interest6PageState extends State<Interest6Page> {
                  ...
                  child: ButtonGreenWidget(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Interest7Page(),
                        ),
                      );
                    },
                  ),
