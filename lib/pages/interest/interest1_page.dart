...
class Interest1Page extends StatefulWidget {
  const Interest1Page({super.key});

  @override
  State<Interest1Page> createState() => _Interest1PageState();
}

class _Interest1PageState extends State<Interest1Page> {
  @override
                  ...
                  child: ButtonGreenWidget(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Interest2Page(),
                        ),
                      );
                    },
                  ),
