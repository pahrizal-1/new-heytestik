...
import 'package:heystetik_mobileapps/pages/interest/interest6_page.dart';
import 'package:heystetik_mobileapps/widget/button_widget.dart';

class Interest5Page extends StatefulWidget {
  const Interest5Page({super.key});

  @override
  State<Interest5Page> createState() => _Interest5PageState();
}

class _Interest5PageState extends State<Interest5Page> {
                  ...
                  child: ButtonGreenWidget(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Interest6Page(),
                        ),
                      );
                    },
                  ),
