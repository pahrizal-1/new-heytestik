...
class CameraWajahBermalahPreasesment extends StatefulWidget {
  const CameraWajahBermalahPreasesment({super.key});

  @override
  State<CameraWajahBermalahPreasesment> createState() =>
      _CameraWajahBermalahPreasesmentState();
}

class _CameraWajahBermalahPreasesmentState
    extends State<CameraWajahBermalahPreasesment> {
                              ...
                              onTap: () async {
                                ...
                                if (controller != null) {
                                  ...
                                  if (controller!.value.isInitialized) {
                                    ...
                                    setState(() {});
                                    Get.to(
                                        HasilPotoWajahBermasalahPreasesment());
                                  }
                                }
