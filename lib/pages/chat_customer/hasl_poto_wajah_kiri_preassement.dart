...
class HasilPotoWajahKiriPreasessment extends StatefulWidget {
  const HasilPotoWajahKiriPreasessment({super.key});

  @override
  State<HasilPotoWajahKiriPreasessment> createState() =>
      _HasilPotoWajahKiriPreasessmentState();
}
  ...
  Future _cropImage() async {
    if (state.initialConditionLeftSide != null) {
      CroppedFile? cropped = await ImageCropper().cropImage(
          sourcePath: state.initialConditionLeftSide!.path,
          aspectRatioPresets: [
      ...
      if (cropped != null) {
        setState(() {
          state.initialConditionLeftSide = File(cropped.path);
        });
      }
    }
  }
