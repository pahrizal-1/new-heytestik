...
class KonsultasiPromoPage extends StatefulWidget {
  const KonsultasiPromoPage({super.key});

  @override
  State<KonsultasiPromoPage> createState() => _KonsultasiPromoPageState();
}

class _KonsultasiPromoPageState extends State<KonsultasiPromoPage> {
  Map<String, dynamic> param = {
    'type[]': ['All Solution Voucher', 'Consultation Voucher']
  };
  VoucherController stateVoucher = Get.put(VoucherController());
  final OrderConsultationController stateOrder =
                      ...
                      if (control.text.isNotEmpty)
                        ...find.map((val) {
                          return InkWell(
                            ...
                            child: PromoVocer(
                              data: val,
                              itsOkay: stateOrder.totalFee.value >
                                  (val.minimumPurchase ?? 0),
