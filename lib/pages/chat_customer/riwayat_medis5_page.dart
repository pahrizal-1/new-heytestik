...
import 'package:heystetik_mobileapps/pages/chat_customer/riwayat_medis6_page.dart';
import 'package:heystetik_mobileapps/widget/button_widget.dart';
import 'package:percent_indicator/percent_indicator.dart';
import 'package:heystetik_mobileapps/widget/appbar_widget.dart';

class RiwayatMedis5Page extends StatefulWidget {
  const RiwayatMedis5Page({super.key});

  @override
  State<RiwayatMedis5Page> createState() => _RiwayatMedis5PageState();
}

class _RiwayatMedis5PageState extends State<RiwayatMedis5Page> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      RichText(
                        text: const TextSpan(
                          text:
                              "Apakah ada kondisi medis / penyakit yang kamu miliki?",
                          style: TextStyle(
                            fontFamily: 'ProximaNova',
                            color: Colors.black,
                            fontWeight: FontWeight.bold,
                        ...
                        child: Container(
                          ...
                          child: const TextField(
                            ...
                            decoration: InputDecoration(
                              hintText: 'SIlakan isi kondisi atau penyakitmu.',
                              hintStyle: TextStyle(
                                  fontSize: 14,
                                  height: 1.3,
                                  fontFamily: 'ProximaNova'),
            ...
            child: ButtonGreenWidget(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const RiwayatMedis6Page(),
                  ),
                );
              },
            ),
