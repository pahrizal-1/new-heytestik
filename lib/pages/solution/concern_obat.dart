...
class CategoryObat extends StatefulWidget {
  String category;
  CategoryObat({required this.category, super.key});

  @override
  State<CategoryObat> createState() => _CategoryObatState();
}

class _CategoryObatState extends State<CategoryObat> {
