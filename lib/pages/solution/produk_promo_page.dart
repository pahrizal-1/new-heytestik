...
class _ProdukPromoPageState extends State<ProdukPromoPage> {
  Map<String, dynamic> param = {
    'type[]': ['All Solution Voucher', 'Product Voucher']
  };
  VoucherController stateVoucher = Get.put(VoucherController());
  final OrderProductController stateOrder = Get.put(OrderProductController());
