    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Padding(
            padding:
                const EdgeInsets.only(top: 25, left: 25, right: 25, bottom: 6),
            child: Column(
              ...
              children: [
                ...
                Text(
                  'All-in-one aesthetic solution for Face, Skin & Body with international accreditation & the most completed treatments in Indonesia.',
                          ...
                          TableRow(
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    'The Broadway Kemang, Jl. Benda No. 46F, Cilandak Timur, Kec. Ps. Minggu, Kota Jakarta Sleatan, Daerah Khusus Ibu Kota Jakarta 12560, Jakarta Selatan, DKI Jakarta',
                                    style: blackRegulerTextStyle.copyWith(
                                        fontSize: 13, fontWeight: regular),
                                  ),
                                  Container(
